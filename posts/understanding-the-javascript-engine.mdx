...
Una vez que llega un archivo de JavaScript llega al navegador y es ejecutado, el engine generará un entorno global que hace tres cosas muy importantes:
...
![Tur por el Abstract syntaxt tree](/posts/understanding-the-javascript-engine/engine-roud-map.png)
